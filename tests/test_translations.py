...
TRANSLATIONS = Path(__file__).parent.parent / "custom_components" / "postnord_tracking" / "translations"
...
def test_finnish_has_the_same_keys_and_placeholders_as_english() -> None:
