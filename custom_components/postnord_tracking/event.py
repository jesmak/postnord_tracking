...
Automations can then act on a package becoming ready for pickup, or being delivered, without
watching the packages attribute themselves.
"""
...
async def async_setup_entry(
    ...
    async_add_entities([PostNordPackageEvent(entry.runtime_data)])


class PostNordPackageEvent(CoordinatorEntity[PostNordCoordinator], EventEntity):
    ...
    def __init__(self, coordinator: PostNordCoordinator) -> None:
        ...
        self._attr_unique_id = f"postnord_{username}_package"
